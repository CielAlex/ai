# -*- coding: utf-8 -*-
"""
Created on Mon Aug 13 23:12:37 2018
使用卷积神经网络
定义PNet NNet RNet
@author: Elliott
"""
...
class LossFn:
    ...
    def cls_loss(self,gt_label,pred_label):
        ...
        return self.loss_cls(valid_pred_label,valid_gt_label)*self.cls_factors
...
class PNet(nn.Module):
    def __init__(self,is_train=False,use_cuda=True):
        ...
        self.pre_layer =nn.Sequential(
                nn.Conv2d(3,10,kernel_size=3,stride=1), #3通道，10个3*3的卷积核
                nn.ReLU(),
        ...
        #brounding box regression
        self.conv4_2 =nn.Conv2d(32,4,kernel_size=1,stride=1)
        #landmark locatlization
        self.conv4_3 =nn.Conv2d(32,10,kernel_size=1,stride=1)
        #weight inition with xavier
        self.apply(weights_init)
    def forward(self,x):
        x = self.pre_layer(x)
        lable =F.sigmoid(self.conv4_1(x))
